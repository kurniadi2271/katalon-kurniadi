...
WebUI.setText(findTestObject('Object Repository/Page_Login/input_username'), 'performance_glitch_user')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_Inventory/span_Products'), 15)

WebUI.verifyElementText(
    findTestObject('Page_Inventory/span_Products'),
    'Products')
